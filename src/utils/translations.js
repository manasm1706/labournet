...
const availableLanguages = ["en", "hi", "mr", "te", "ml", "ta", "kn", "gu", "pa"];
...
const translations = {
  ...
  mr: {
    ...
    "workerDashboard.jobListings": "नोकरी তালिকা",
  ...
  te: {
    ...
    "workerProfile.skills": "నైపుణ్యాలు",
  ...
  ml: {
    ...
    "footer.quickLinks": "ദ്രുത കണ്ണികൾ",
    "footer.services": "ഞങ്ങളുടെ സേവനങ്ങൾ",
    "footer.projectManagement": "പദ്ധതി നിർവഹണം",
  ...
  gu: {
    ...
    "header.getInTouch": "સંપર્કમાં રહેવું",
...
export { availableLanguages, translations };
